   ...
   */    printWarning = function(text) {
    ...
    var CellMeasurerCacheDecorator = function() {
        ...
        return _inherits(MultiGrid, React.PureComponent), _createClass(MultiGrid, [ {
            ...
            value: function(props) {
                var enableFixedColumnScroll = props.enableFixedColumnScroll, fixedColumnCount = props.fixedColumnCount, fixedRowCount = props.fixedRowCount, rowCount = props.rowCount, hideBottomLeftGridScrollbar = props.hideBottomLeftGridScrollbar, showHorizontalScrollbar = this.state.showHorizontalScrollbar;
                if (!fixedColumnCount) return null;
                var additionalRowCount = showHorizontalScrollbar ? 1 : 0, height = this._getBottomGridHeight(props), width = this._getLeftGridWidth(props), scrollbarSize = this.state.showVerticalScrollbar ? this.state.scrollbarSize : 0, gridWidth = hideBottomLeftGridScrollbar ? width + scrollbarSize : width, bottomLeftGrid = React.createElement(Grid, _extends({}, props, {
